...
<html>
  ...
  function add(){
		...
		$.ajax({
             type: "post",
             url: "<%=basePath%>weekday/doinsertweekday",
             data: {
  ...
  <!-- 页面位置 -->
    ...
    <div class="rightinfo">
   	<div class="itab">
	    ...
	    <li><a href="<%=basePath %>weekday/toinsertweekday" class="selected">周期添加</a></li> 
	  	</ul>
	</div> 
	...
	<div id="tab1" class="tabson">
	    <ul class="forminfo">
	    	...
	    	<input type="text" id="start_date" name="start_date" value="" maxlength="25"  class="dfinput150 ui_timepicker"  readonly/>
	    	</li>
		    <li><label>周期结束时间：<b>*</b></label>
	    	<input type="text" id="end_date" name="end_date" value="" maxlength="25"  class="dfinput150 ui_timepicker"  readonly/>
	    	</li>
