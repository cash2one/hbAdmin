...
<html>
   ...
   function addAdmin(){
		...
		$.ajax({
             type: "post",
             url: "<%=basePath %>globalHobby/add?callback=?",
             data: {
		...
		<div class="rightinfo">
			...
			<div class="itab">
				<ul>
					...
					<li>
						<a href="<%=basePath %>globalHobby/toadd?index=${index }" class="selected">兴趣添加</a>
					</li>
				</ul>
			</div>
			...
			<div id="tab1" class="tabson">
				...
				<ul class="forminfo">
					<li>
						...
						<input type="text" id="hobby_content" name="hobby_content" size="30"
							class="dfinput150" />
						...
						<fieldset style="padding:15px;width:77%;border:1px solid #c7c7c7;">
						    ...
						    <c:if test="${gllist!=null}">
								<c:forEach var="gl" items="${gllist}">
									<input  type="checkbox"  name="level_id" value="${gl.id }" />${gl.level_content }&nbsp;&nbsp;&nbsp;&nbsp;
					   			</c:forEach>
							</c:if>
					  	</fieldset>
					</li>
					<li>
						...
						<input type="text" id="hobby_summary" name="hobby_summary" size="30"
							class="dfinput150" />
					</li>
					<li>
						<label>
						...
						<input type="hidden" id="hobby_img" name="hobby_img" value="" class="dfinput150" readonly >
						...
						<div id = "hobby_img_list" style="padding-left:118px;">
							<img style="display: none" id="see_hobby_img" src="" width="150" height="150">
						</div>
					</li>
					<li>
						<label>
